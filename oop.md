...
Дополнительно к требованию "part-of" накладывается условие, что экземпляр "части" может входить только в одно целое (или никуда не входить), 
в то время как в случае агрегации экземпляр "части" может входить в несколько целых.
